          ...
          {is_done ? (
            ...
            <>
              <button
                ...
                onClick={convert}
                className="relative font-semibold cursor pointer overflow-hidden rounded-xl border border-[#323228] px-5 py-2.5  transition-all shadow-sm shadow-[#0e100f]/20 active:scale-[.95]"
              >
                {is_converting ? (
